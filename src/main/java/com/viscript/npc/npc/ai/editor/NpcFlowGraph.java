...
public class NpcFlowGraph extends Graph {
    public static final GraphNodeRegistry NODE_REGISTRY = GraphNodeRegistry.create(ViScriptNpc.id("npc_flow"), NpcFlowGraph.class);
    ...
    public List<TypeHandle> getSupportTypes(){return List.of(TypeHandles.BOOL,TypeHandles.INT,TypeHandles.FLOAT,TypeHandles.DOUBLE,TypeHandles.STRING,TypeHandles.ENTITY_TYPE);}
